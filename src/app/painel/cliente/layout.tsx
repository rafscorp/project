...
export default function CustomerDashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col md:flex-row">
      {/* Sidebar do Cliente */}
      <aside className="w-full md:w-64 bg-zinc-900 border-b md:border-b-0 md:border-r border-white/5 flex flex-col shrink-0 md:sticky md:top-0 md:h-screen">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-x-auto md:overflow-x-visible flex md:flex-col">
          ...
          <Link href="/lojas" className="flex items-center gap-3 px-4 py-3 rounded-xl text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors font-medium whitespace-nowrap">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-20 bg-zinc-950/50 backdrop-blur-xl border-b border-white/5 flex items-center px-8 sticky top-0 z-10 hidden md:flex">
