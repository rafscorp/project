...
export function CustomPartRequest({ storeId, storeName, isCustomer, storeSlug }: CustomPartRequestProps) {
  ...
  if (success) {
    return (
      <div className="mt-12 overflow-hidden rounded-[2rem] border border-emerald-500/20 bg-zinc-900/40 p-12 text-center relative animate-scale-in">
        <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/5 to-transparent pointer-events-none" />
        <div className="w-20 h-20 bg-emerald-500/10 border border-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
          <CheckCircle2 className="h-10 w-10 text-emerald-400" />
        </div>
        <h3 className="font-display font-black text-3xl text-white mb-4">Pedido de Orçamento Enviado!</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button onClick={() => setSuccess(false)} variant="outline" className="border-white/10 hover:bg-zinc-800 text-white font-bold h-12 px-8">
  ...
  return (
    <div className="mt-12 overflow-hidden rounded-[2rem] border border-white/5 bg-zinc-900/40 relative backdrop-blur-md">
      ...
      <div className="flex flex-col lg:flex-row items-stretch">
        ...
        <div className="p-8 md:p-12 lg:w-5/12 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-white/5 relative z-10">
          ...
          <h3 className="font-display font-black text-3xl text-white mb-4">Peça sob Encomenda</h3>
          ...
          <div className="space-y-4 mb-8 text-zinc-300 font-medium text-sm">
          ...
          <div className="bg-zinc-950/40 border border-white/5 rounded-2xl p-4 flex items-center gap-3">
        ...
        {/* PANEL DO FORMULÁRIO */}
        <div className="p-8 md:p-12 lg:w-7/12 relative z-10 flex flex-col justify-center bg-zinc-950/20">

          {/* Seleção do Modo (Placa vs Manual) */}
          <div className="flex bg-zinc-900/80 border border-white/5 rounded-xl p-1 mb-8">
            <button
              type="button"
              onClick={() => { setMode("placa"); setError(""); }}
              className={`flex-1 py-2.5 text-xs sm:text-sm font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${mode === "placa" ? "bg-emerald-600 text-white shadow-lg shadow-emerald-600/10" : "text-zinc-400 hover:text-white"}`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2.5 text-xs sm:text-sm font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${mode === "manual" ? "bg-emerald-600 text-white shadow-lg shadow-emerald-600/10" : "text-zinc-400 hover:text-white"}`}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {mode === "placa" && !vehicleData && (
              <div className="space-y-4 bg-zinc-900/30 p-6 rounded-2xl border border-white/5 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-zinc-500">Ex: ABC1234 ou ABC1D23</span>
                </div>
                ...
                <div className="flex gap-3">
                  <div className="relative flex-1">
                    <input
                      ...
                      maxLength={8}
                      className="w-full bg-zinc-950 border border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-emerald-500/50 outline-none uppercase font-mono tracking-widest text-xl text-center placeholder:text-zinc-700"
                    />
                  </div>
                  ...
                  <Button
                    ...
                    disabled={searchingPlaca || placa.replace(/[^a-zA-Z0-9]/g, "").length < 7}
              ...
              <div className="rounded-2xl overflow-hidden border border-emerald-500/30 bg-emerald-500/5 animate-scale-in">
                ...
                <div className="px-6 py-4 bg-emerald-500/10 border-b border-emerald-500/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <button
                    type="button"
                    onClick={handleReset}
                    className="text-zinc-500 hover:text-white text-xs font-bold transition-colors flex items-center gap-1.5 self-start sm:self-center"
                  >
                ...
                <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 bg-zinc-950/40">
                  
                  {/* Marca */}
                  <div className="bg-zinc-900/60 rounded-xl p-3 border border-white/5 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-black text-xs sm:text-sm mt-0.5">
                        {vehicleData.marca}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-900/60 rounded-xl p-3 border border-white/5 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Ano</p>
                      <p className="text-white font-black text-xs sm:text-sm mt-0.5">
                        {vehicleData.ano}
                      </p>
                    </div>
                  ...
                  <div className="bg-zinc-900/60 rounded-xl p-3 border border-white/5 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-black text-xs sm:text-sm mt-0.5 capitalize">
                  ...
                  <div className="bg-zinc-900/60 rounded-xl p-3 border border-white/5 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Chassi</p>
                      <p className="text-white font-mono font-bold text-xs sm:text-sm mt-0.5 select-all">
                        {vehicleData.chassi || "—"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-900/60 rounded-xl p-3 border border-white/5 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider">Número do Motor</p>
                      <p className="text-white font-mono font-bold text-xs sm:text-sm mt-0.5 select-all">
                        {vehicleData.motor || "—"}
                      </p>
                    </div>
            ...
            {mode === "manual" && (
              <div className="space-y-4 bg-zinc-900/30 p-6 rounded-2xl border border-white/5 animate-scale-in">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-300">Marca *</label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-zinc-950 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:ring-2 focus:ring-emerald-500/50 outline-none"
                    />
                  </div>

                  {/* Modelo */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-300">Modelo *</label>
                    <input
                      type="text"
                  ...
                  {/* Ano */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-300">Ano *</label>
                    <input
                      type="text"
                      placeholder="Ex: 2021"
                      required
                  ...
                  {/* Cor */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-300">Cor</label>
                    <input
                      type="text"
                  ...
                  {/* Chassi */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-300">Chassi (Opcional)</label>
                    <input
                      type="text"
                      placeholder="Insira os 17 dígitos"
                      value={manualChassi}
                      onChange={e => setManualChassi(e.target.value)}
                      className="w-full bg-zinc-950 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white font-mono focus:ring-2 focus:ring-emerald-500/50 outline-none"
                    />
                  </div>

                  {/* Motor */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-zinc-300">Número do Motor (Opcional)</label>
                    <input
                      type="text"
            ...
            <div className={`space-y-2 transition-all duration-300 ${mode === "placa" && !vehicleData ? "opacity-25 pointer-events-none" : "opacity-100"}`}>
              <div className="flex justify-between items-center">
                <label className="text-xs font-black text-zinc-300 uppercase tracking-wider">Descrição das Peças Necessárias *</label>
                <span className="text-[10px] text-zinc-500">Seja o mais específico possível</span>
              </div>
              <textarea
                required
                rows={4}
                ...
                className="w-full bg-zinc-900/60 border border-white/10 rounded-2xl px-4 py-3 text-sm text-white focus:ring-2 focus:ring-emerald-500/50 outline-none resize-none placeholder:text-zinc-600"
              />
            </div>
            ...
            <div className="pt-4">
              ...
              <p className="text-center text-[10px] text-zinc-500 mt-4 leading-normal">
