...
export function RegionFilter() {
  ...
  return (
    <div className="mb-8">
      <h4 className="font-bold text-foreground/80 mb-4">Região</h4>
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              disabled={loadingUf}
              className="w-full bg-background border border-border-subtle rounded-xl px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-violet-500/50 appearance-none transition-all disabled:opacity-50"
            >
            ...
            {loadingUf && <Loader2 className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground animate-spin" />}
          </div>
        </div>
        ...
        {currentState && (
          <div>
            ...
            <div className="relative animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              {loadingCity && <Loader2 className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground animate-spin" />}
            </div>
          </div>
        )}
      </div>
